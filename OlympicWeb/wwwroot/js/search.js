...
function getList(idName, url) {
    ...
    xhttp.open("GET", "https://localhost:44328/api/Search/" + url, true);
    xhttp.send();
}
...
function getBestAthlete(sport) {
    ...
    xhttp.open("GET", "https://localhost:44328/api/Search/best_athlete/" + sportstr, true);
    xhttp.send();
}
function getLocation(game) {
    ...
    xhttp.open("GET", "https://localhost:44328/api/Search/location/" + game, true);
    xhttp.send();
}
...
function getTheAnswerMost(str) {
    ...
    xhttp.open("GET", "https://localhost:44328/api/Search/the_most/" + str, true);
    xhttp.send();
}
...
function filter(atr) {
    ...
    var str = "https://localhost:44328/api/Search/filter/";
