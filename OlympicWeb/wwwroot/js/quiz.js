...
function get_quiz() {
    ...
    var st = "https://localhost:44328/api/Quiz/" + quiz_st;
...
Quiz.prototype.render = function (container) {
    ...
    $('#submit-button').click(function () {
        ...
        if (score >= 3) {
            ...
            xhttp.open("POST", "https://localhost:44328/api/Users/admin/" + admin_username + "&" + cur_sport_field + "&" + cur_admin_field, true);
            xhttp.send();
        }
